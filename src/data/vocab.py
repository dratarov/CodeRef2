...
class Vocab(object):
    ...
    TASK_RTD_TOKEN = 'TASK_RTD:'
    TASK_AUTOCOMPLETION_TOKEN = 'TASK_AUTOCOMPLETION:'
    TASK_CODE_AST_PREDICTION_TOKEN = 'TASK_CODE_AST_PREDICTION:'
    TASK_METHOD_NAME_PREDICTION_TOKEN = 'TASK_METHOD_NAME_PREDICTION:'
    TASK_MLM_TOKEN = 'TASK_MLM:'
    TASK_MASS_TOKEN = 'TASK_MASS:'
    TASK_METHOD_DOCS_PREDICTION_TOKEN = 'TASK_METHOD_DOCS_PREDICTION:'
    TASK_IDENTIFIER_TAGGING_TOKEN = 'TASK_IDENTIFIER_TAGGING:'
    TASK_MIP_TOKEN = 'TASK_MIP:'
    TASK_BUG_FIX_TOKEN = 'TASK_BUG_FIX:'
    CODE_2_CODE_TOKEN = 'CODE_2_CODE:'
    CODE_2_COMMENT_TOKEN = 'CODE_2_COMMENT:'
    BUG_FIX_START_TOKEN = '<START>'
    BUG_FIX_END_TOKEN = '<END>'
    ...
    START_VOCAB = [
        PAD_TOKEN, SOS_TOKEN, EOS_TOKEN, UNK_TOKEN, MSK_TOKEN, SEP_TOKEN, TASK_RTD_TOKEN, TASK_AUTOCOMPLETION_TOKEN, TASK_CODE_AST_PREDICTION_TOKEN,
        TASK_METHOD_NAME_PREDICTION_TOKEN, TASK_MLM_TOKEN, TASK_MASS_TOKEN, TASK_METHOD_DOCS_PREDICTION_TOKEN, TASK_IDENTIFIER_TAGGING_TOKEN, TASK_MIP_TOKEN,
        TASK_BUG_FIX_TOKEN, CODE_2_CODE_TOKEN, CODE_2_COMMENT_TOKEN, BUG_FIX_START_TOKEN, BUG_FIX_END_TOKEN
    ]
